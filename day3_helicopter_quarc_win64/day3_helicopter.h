...
#ifndef RTW_HEADER_day3_helicopter_h_
#define RTW_HEADER_day3_helicopter_h_
#include <math.h>
#include <stddef.h>
#include <string.h>
#ifndef day3_helicopter_COMMON_INCLUDES_
#define day3_helicopter_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* day3_helicopter_COMMON_INCLUDES_ */

#include "day3_helicopter_types.h"
...
#define day3_helicopter_rtModel        RT_MODEL_day3_helicopter_T
...
#define rtB                            day3_helicopter_B
#define BlockIO                        B_day3_helicopter_T
#define rtX                            day3_helicopter_X
#define ContinuousStates               X_day3_helicopter_T
#define rtXdot                         day3_helicopter_XDot
#define StateDerivatives               XDot_day3_helicopter_T
#define tXdis                          day3_helicopter_XDis
#define StateDisabled                  XDis_day3_helicopter_T
#define rtP                            day3_helicopter_P
#define Parameters                     P_day3_helicopter_T
#define rtDWork                        day3_helicopter_DW
#define D_Work                         DW_day3_helicopter_T

/* Parameters (default storage) */
struct P_day3_helicopter_T_ {
...
struct tag_RTM_day3_helicopter_T {
  const char_T *path;
...
extern P_day3_helicopter_T day3_helicopter_P;

/* Block signals (default storage) */
extern B_day3_helicopter_T day3_helicopter_B;

/* Continuous states (default storage) */
extern X_day3_helicopter_T day3_helicopter_X;

/* Block states (default storage) */
extern DW_day3_helicopter_T day3_helicopter_DW;

/* Model entry point functions */
extern void day3_helicopter_initialize(void);
extern void day3_helicopter_output(void);
extern void day3_helicopter_update(void);
extern void day3_helicopter_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern day3_helicopter_rtModel *day3_helicopter(void);
...
extern RT_MODEL_day3_helicopter_T *const day3_helicopter_M;
 ...
 *
 * '<Root>' : 'day3_helicopter'
 * '<S1>'   : 'day3_helicopter/Conversion'
 * '<S2>'   : 'day3_helicopter/Degrees to Radians'
 * '<S3>'   : 'day3_helicopter/Elevation controller'
 * '<S4>'   : 'day3_helicopter/Helicopter_interface'
 * '<S5>'   : 'day3_helicopter/LQ'
 * '<S6>'   : 'day3_helicopter/Pitch controller'
 * '<S7>'   : 'day3_helicopter/Elevation controller/If Action Subsystem'
 * '<S8>'   : 'day3_helicopter/Helicopter_interface/Elevation rad to deg'
 * '<S9>'   : 'day3_helicopter/Helicopter_interface/Elevation rate rad to deg'
 * '<S10>'  : 'day3_helicopter/Helicopter_interface/Pitch rad to deg'
 * '<S11>'  : 'day3_helicopter/Helicopter_interface/Pitch rate rad to deg'
 * '<S12>'  : 'day3_helicopter/Helicopter_interface/Pitch rate rad to deg1'
 * '<S13>'  : 'day3_helicopter/Helicopter_interface/Travel rad to deg'
 * '<S14>'  : 'day3_helicopter/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_day3_helicopter_h_ */
