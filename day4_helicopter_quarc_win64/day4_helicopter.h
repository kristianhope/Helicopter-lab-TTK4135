...
#ifndef RTW_HEADER_day4_helicopter_h_
#define RTW_HEADER_day4_helicopter_h_
#include <math.h>
#include <stddef.h>
#include <string.h>
#ifndef day4_helicopter_COMMON_INCLUDES_
#define day4_helicopter_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* day4_helicopter_COMMON_INCLUDES_ */

#include "day4_helicopter_types.h"
...
#define day4_helicopter_rtModel        RT_MODEL_day4_helicopter_T
...
#define rtB                            day4_helicopter_B
#define BlockIO                        B_day4_helicopter_T
#define rtX                            day4_helicopter_X
#define ContinuousStates               X_day4_helicopter_T
#define rtXdot                         day4_helicopter_XDot
#define StateDerivatives               XDot_day4_helicopter_T
#define tXdis                          day4_helicopter_XDis
#define StateDisabled                  XDis_day4_helicopter_T
#define rtP                            day4_helicopter_P
#define Parameters                     P_day4_helicopter_T
#define rtDWork                        day4_helicopter_DW
#define D_Work                         DW_day4_helicopter_T
...
struct tag_RTM_day4_helicopter_T {
  const char_T *path;
...
extern P_day4_helicopter_T day4_helicopter_P;

/* Block signals (default storage) */
extern B_day4_helicopter_T day4_helicopter_B;

/* Continuous states (default storage) */
extern X_day4_helicopter_T day4_helicopter_X;

/* Block states (default storage) */
extern DW_day4_helicopter_T day4_helicopter_DW;

/* Model entry point functions */
extern void day4_helicopter_initialize(void);
extern void day4_helicopter_output(void);
extern void day4_helicopter_update(void);
extern void day4_helicopter_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern day4_helicopter_rtModel *day4_helicopter(void);
...
extern RT_MODEL_day4_helicopter_T *const day4_helicopter_M;
 ...
 *
 * '<Root>' : 'day4_helicopter'
 * '<S1>'   : 'day4_helicopter/Conversion'
 * '<S2>'   : 'day4_helicopter/Degrees to Radians'
 * '<S3>'   : 'day4_helicopter/Elevation controller'
 * '<S4>'   : 'day4_helicopter/Helicopter_interface'
 * '<S5>'   : 'day4_helicopter/LQ'
 * '<S6>'   : 'day4_helicopter/Pitch controller'
 * '<S7>'   : 'day4_helicopter/Elevation controller/If Action Subsystem'
 * '<S8>'   : 'day4_helicopter/Helicopter_interface/Elevation rad to deg'
 * '<S9>'   : 'day4_helicopter/Helicopter_interface/Elevation rate rad to deg'
 * '<S10>'  : 'day4_helicopter/Helicopter_interface/Pitch rad to deg'
 * '<S11>'  : 'day4_helicopter/Helicopter_interface/Pitch rate rad to deg'
 * '<S12>'  : 'day4_helicopter/Helicopter_interface/Pitch rate rad to deg1'
 * '<S13>'  : 'day4_helicopter/Helicopter_interface/Travel rad to deg'
 * '<S14>'  : 'day4_helicopter/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_day4_helicopter_h_ */
