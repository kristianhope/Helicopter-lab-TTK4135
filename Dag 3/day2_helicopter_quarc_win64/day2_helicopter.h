 ...
 * C source code generated on : Tue Mar  8 09:10:45 2022
 *
...
#ifndef RTW_HEADER_day2_helicopter_h_
#define RTW_HEADER_day2_helicopter_h_
#include <math.h>
#include <stddef.h>
#include <string.h>
#ifndef day2_helicopter_COMMON_INCLUDES_
#define day2_helicopter_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* day2_helicopter_COMMON_INCLUDES_ */

#include "day2_helicopter_types.h"
...
#define day2_helicopter_rtModel        RT_MODEL_day2_helicopter_T
...
#define rtB                            day2_helicopter_B
#define BlockIO                        B_day2_helicopter_T
#define rtX                            day2_helicopter_X
#define ContinuousStates               X_day2_helicopter_T
#define rtXdot                         day2_helicopter_XDot
#define StateDerivatives               XDot_day2_helicopter_T
#define tXdis                          day2_helicopter_XDis
#define StateDisabled                  XDis_day2_helicopter_T
#define rtP                            day2_helicopter_P
#define Parameters                     P_day2_helicopter_T
#define rtDWork                        day2_helicopter_DW
#define D_Work                         DW_day2_helicopter_T

/* Parameters (default storage) */
struct P_day2_helicopter_T_ {
...
struct tag_RTM_day2_helicopter_T {
  const char_T *path;
...
extern P_day2_helicopter_T day2_helicopter_P;

/* Block signals (default storage) */
extern B_day2_helicopter_T day2_helicopter_B;

/* Continuous states (default storage) */
extern X_day2_helicopter_T day2_helicopter_X;

/* Block states (default storage) */
extern DW_day2_helicopter_T day2_helicopter_DW;

/* Model entry point functions */
extern void day2_helicopter_initialize(void);
extern void day2_helicopter_output(void);
extern void day2_helicopter_update(void);
extern void day2_helicopter_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern day2_helicopter_rtModel *day2_helicopter(void);
...
extern RT_MODEL_day2_helicopter_T *const day2_helicopter_M;
 ...
 *
 * '<Root>' : 'day2_helicopter'
 * '<S1>'   : 'day2_helicopter/Conversion'
 * '<S2>'   : 'day2_helicopter/Degrees to Radians'
 * '<S3>'   : 'day2_helicopter/Elevation controller'
 * '<S4>'   : 'day2_helicopter/Helicopter_interface'
 * '<S5>'   : 'day2_helicopter/Pitch controller'
 * '<S6>'   : 'day2_helicopter/Elevation controller/If Action Subsystem'
 * '<S7>'   : 'day2_helicopter/Helicopter_interface/Elevation rad to deg'
 * '<S8>'   : 'day2_helicopter/Helicopter_interface/Elevation rate rad to deg'
 * '<S9>'   : 'day2_helicopter/Helicopter_interface/Pitch rad to deg'
 * '<S10>'  : 'day2_helicopter/Helicopter_interface/Pitch rate rad to deg'
 * '<S11>'  : 'day2_helicopter/Helicopter_interface/Pitch rate rad to deg1'
 * '<S12>'  : 'day2_helicopter/Helicopter_interface/Travel rad to deg'
 * '<S13>'  : 'day2_helicopter/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_day2_helicopter_h_ */
