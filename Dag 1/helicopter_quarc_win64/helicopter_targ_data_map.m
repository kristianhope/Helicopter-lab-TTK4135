  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% helicopter_P.HILReadAnalog_channels
	  section.data(2).logicalSrcIdx = 10;
	  section.data(2).dtTransOffset = 2;
	
	  ;% helicopter_P.HILReadEncoder_channels
	  ...
	  ;% helicopter_P.HILReadAnalog_Active
	  section.data(38).logicalSrcIdx = 113;
	  section.data(38).dtTransOffset = 37;
	
	  ;% helicopter_P.HILReadEncoder_Active
  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% helicopter_B.HILReadAnalog
	  section.data(14).logicalSrcIdx = 13;
	  section.data(14).dtTransOffset = 13;
	
	  ;% helicopter_B.HILReadEncoder
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% helicopter_DW.HILReadAnalog_PWORK
	  section.data(12).logicalSrcIdx = 27;
	  section.data(12).dtTransOffset = 17;
	
	  ;% helicopter_DW.HILReadEncoder_PWORK
  ...
  targMap.checksum0 = 2226957924;
  targMap.checksum1 = 2188352731;
  targMap.checksum2 = 3728478050;
  targMap.checksum3 = 1729431675;
